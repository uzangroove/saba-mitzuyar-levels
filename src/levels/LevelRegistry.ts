...
export interface EnemyConfig {
  type: 'slime' | 'beetle' | 'spinner' | 'jellyfish' | 'crab' | 'bird' | 'robot';
  difficulty?: number;
  x: number;
  y: number;
...
export const LEVELS: LevelData[] = [
  // ---- LEVEL 1: Tutorial Earth ----
  {
    ...
    enemies: [
      { type: 'slime', x: 400,  y: 460, patrolDistance: 180, variant: 0 },
      { type: 'slime', x: 800,  y: 460, patrolDistance: 120, variant: 1 },
      { type: 'slime', x: 1200, y: 460, patrolDistance: 200, variant: 0 },
    ],
    coins: [
  ...
  // ---- LEVEL 2: Earth — Wider Gaps ----
  {
    ...
    enemies: [
      ...
      { type: 'slime',  x: 200,  y: 495, patrolDistance: 160, variant: 0 },
      // Right bank - solid ground (platform top y=500)
      { type: 'slime',  x: 1250, y: 495, patrolDistance: 90,  variant: 1 },
      { type: 'beetle', x: 1500, y: 495, patrolDistance: 100, variant: 0 },
    ],
    coins: [
  ...
  // ---- LEVEL 3: Earth — Sunset ----
  {
    ...
    enemies: [
      { type: 'slime',  x: 300, y: 410, patrolDistance: 200, variant: 1 },
      { type: 'beetle', x: 700, y: 410, patrolDistance: 140, variant: 0 },
      { type: 'beetle', x: 1100, y: 410, patrolDistance: 160, variant: 1 },
      { type: 'slime',  x: 1500, y: 410, patrolDistance: 120, variant: 0 },
    ],
    coins: [
...
const earthLevel4: LevelData = {
  ...
  enemies: [
    { type: 'slime',  x: 180,  y: 495, patrolDistance: 120, variant: 1 },
    { type: 'beetle', x: 1000, y: 495, patrolDistance: 150, variant: 0 },
    { type: 'slime',  x: 1900, y: 495, patrolDistance: 100, variant: 2 },
    { type: 'beetle', x: 2100, y: 495, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const earthLevel5: LevelData = {
  ...
  enemies: [
    { type: 'slime',   x: 150,  y: 495, patrolDistance: 100, variant: 0 },
    { type: 'spinner', x: 850,  y: 495, patrolDistance: 160, variant: 0 },
    { type: 'slime',   x: 1750, y: 495, patrolDistance: 120, variant: 2 },
    { type: 'beetle',  x: 1950, y: 495, patrolDistance: 100, variant: 0 },
    { type: 'spinner', x: 2200, y: 495, patrolDistance: 130, variant: 0 },
  ],
  coins: [
...
const earthLevel6: LevelData = {
  ...
  enemies: [
    { type: 'beetle',  x: 320,  y: 495, patrolDistance: 120, variant: 0 },
    { type: 'slime',   x: 600,  y: 495, patrolDistance: 120, variant: 1 },
    { type: 'spinner', x: 1100, y: 495, patrolDistance: 200, variant: 0 },
    { type: 'beetle',  x: 2000, y: 495, patrolDistance: 150, variant: 0 },
    { type: 'slime',   x: 2200, y: 495, patrolDistance: 120, variant: 2 },
    { type: 'spinner', x: 2440, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const earthLevel7: LevelData = {
  ...
  enemies: [
    { type: 'slime',   x: 180,  y: 495, patrolDistance: 120, variant: 0 },
    { type: 'spinner', x: 1200, y: 495, patrolDistance: 160, variant: 0 },
    { type: 'beetle',  x: 1400, y: 495, patrolDistance: 100, variant: 0 },
    { type: 'slime',   x: 2150, y: 495, patrolDistance: 130, variant: 1 },
    { type: 'spinner', x: 2380, y: 495, patrolDistance: 120, variant: 0 },
    { type: 'beetle',  x: 2650, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const earthLevel8: LevelData = {
  ...
  enemies: [
    { type: 'beetle',  x: 290,  y: 345, patrolDistance: 50,  variant: 0 },
    { type: 'slime',   x: 1150, y: 385, patrolDistance: 180, variant: 2 },
    { type: 'spinner', x: 1490, y: 345, patrolDistance: 50,  variant: 0 },
    { type: 'beetle',  x: 1950, y: 385, patrolDistance: 180, variant: 0 },
    { type: 'slime',   x: 2730, y: 385, patrolDistance: 150, variant: 1 },
    { type: 'spinner', x: 2900, y: 385, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const earthLevel9: LevelData = {
  ...
  enemies: [
    { type: 'slime',   x: 150,  y: 495, patrolDistance: 100, variant: 1 },
    { type: 'beetle',  x: 1100, y: 495, patrolDistance: 200, variant: 0 },
    { type: 'spinner', x: 1460, y: 415, patrolDistance: 50,  variant: 0 },
    { type: 'slime',   x: 2040, y: 495, patrolDistance: 200, variant: 2 },
    { type: 'beetle',  x: 2400, y: 415, patrolDistance: 50,  variant: 0 },
    { type: 'spinner', x: 2850, y: 495, patrolDistance: 150, variant: 0 },
    { type: 'slime',   x: 3050, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const waterLevel13: LevelData = {
  ...
  enemies: [
    { type: 'jellyfish', x: 180,  y: 495, patrolDistance: 120, variant: 0 },
    { type: 'jellyfish', x: 900,  y: 495, patrolDistance: 180, variant: 1 },
    { type: 'crab',      x: 1680, y: 495, patrolDistance: 160, variant: 0 },
    { type: 'crab',      x: 1940, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const waterLevel14: LevelData = {
  ...
  enemies: [
    { type: 'crab',      x: 700,  y: 495, patrolDistance: 130, variant: 0 },
    { type: 'jellyfish', x: 1420, y: 495, patrolDistance: 200, variant: 0 },
    { type: 'jellyfish', x: 1760, y: 415, patrolDistance: 50,  variant: 1 },
    { type: 'crab',      x: 2220, y: 495, patrolDistance: 180, variant: 0 },
    { type: 'jellyfish', x: 2440, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const waterLevel15: LevelData = {
  ...
  enemies: [
    { type: 'jellyfish', x: 290,  y: 345, patrolDistance: 50,  variant: 1 },
    { type: 'crab',      x: 1140, y: 385, patrolDistance: 200, variant: 0 },
    { type: 'jellyfish', x: 1510, y: 345, patrolDistance: 50,  variant: 0 },
    { type: 'crab',      x: 2360, y: 385, patrolDistance: 200, variant: 0 },
    { type: 'jellyfish', x: 2590, y: 385, patrolDistance: 120, variant: 1 },
    { type: 'crab',      x: 2780, y: 385, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
...
const waterBoss20: LevelData = {
  ...
  enemies: [
    { type: 'jellyfish', x: 400,  y: 495, patrolDistance: 100, variant: 0 },
    { type: 'jellyfish', x: 800,  y: 495, patrolDistance: 100, variant: 1 },
    { type: 'jellyfish', x: 1200, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const skyLevel21: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 160,  y: 385, patrolDistance: 140, variant: 0 },
    { type: 'bird', x: 820,  y: 385, patrolDistance: 140, variant: 1 },
    { type: 'bird', x: 1500, y: 385, patrolDistance: 140, variant: 0 },
    { type: 'bird', x: 2200, y: 265, patrolDistance: 120, variant: 1 },
  ],
  coins: [
...
const skyLevel22: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 60,   y: 385, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 550,  y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 980,  y: 385, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 1510, y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1940, y: 385, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const skyLevel23: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 100,  y: 405, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 570,  y: 245, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1000, y: 405, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 1530, y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1960, y: 405, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 2370, y: 245, patrolDistance: 80,  variant: 1 },
  ],
  coins: [
...
const skyBoss30: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 400,  y: 425, patrolDistance: 150, variant: 0 },
    { type: 'bird', x: 900,  y: 425, patrolDistance: 150, variant: 1 },
    { type: 'bird', x: 1400, y: 425, patrolDistance: 150, variant: 0 },
  ],
  coins: [
...
const spaceLevel33: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 100,  y: 385, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 570,  y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 1000, y: 385, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 1530, y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 1960, y: 385, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const spaceLevel34: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 90,   y: 405, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 550,  y: 245, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 980,  y: 405, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 1510, y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'robot', x: 1940, y: 405, patrolDistance: 100, variant: 1 },
    { type: 'robot', x: 2350, y: 245, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
...
const spaceBoss40: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 400,  y: 425, patrolDistance: 150, variant: 0 },
    { type: 'robot', x: 900,  y: 425, patrolDistance: 150, variant: 1 },
    { type: 'robot', x: 1400, y: 425, patrolDistance: 150, variant: 0 },
  ],
  coins: [
    { x: 300, y: 420 }, { x: 700, y: 420 }, { x: 1100, y: 420 },
...
const waterLevel11: LevelData = {
  ...
  enemies: [
    { x: 300,  y: 360, type: 'jellyfish', patrolDistance: 100 },
    { x: 600,  y: 320, type: 'crab',      patrolDistance: 80 },
    { x: 850,  y: 280, type: 'jellyfish', patrolDistance: 120, variant: 1 },
    { x: 1100, y: 330, type: 'crab',      patrolDistance: 90 },
    { x: 1400, y: 290, type: 'jellyfish', patrolDistance: 100 },
  ],
  coins: [
...
const waterLevel12: LevelData = {
  ...
  enemies: [
    { x: 260,  y: 390, type: 'jellyfish', patrolDistance: 80 },
    { x: 500,  y: 340, type: 'crab',      patrolDistance: 70, variant: 1 },
    { x: 720,  y: 300, type: 'jellyfish', patrolDistance: 100 },
    { x: 980,  y: 350, type: 'crab',      patrolDistance: 85 },
    { x: 1200, y: 290, type: 'jellyfish', patrolDistance: 110 },
    { x: 1440, y: 330, type: 'crab',      patrolDistance: 80, variant: 1 },
  ],
  coins: [
...
const spaceLevel31: LevelData = {
  ...
  enemies: [
    { x: 250,  y: 410, type: 'robot', patrolDistance: 70 },
    { x: 460,  y: 360, type: 'bird',  patrolDistance: 90 },
    { x: 660,  y: 300, type: 'robot', patrolDistance: 75, variant: 1 },
    { x: 880,  y: 250, type: 'bird',  patrolDistance: 80 },
    { x: 1100, y: 310, type: 'robot', patrolDistance: 85 },
    { x: 1320, y: 260, type: 'bird',  patrolDistance: 90, variant: 1 },
    { x: 1560, y: 300, type: 'robot', patrolDistance: 70 },
  ],
  coins: [
...
const spaceLevel32: LevelData = {
  ...
  enemies: [
    { x: 300,  y: 390, type: 'bird',  patrolDistance: 80 },
    { x: 520,  y: 330, type: 'robot', patrolDistance: 70 },
    { x: 760,  y: 270, type: 'bird',  patrolDistance: 85, variant: 1 },
    { x: 1000, y: 220, type: 'robot', patrolDistance: 75 },
    { x: 1240, y: 270, type: 'bird',  patrolDistance: 90 },
    { x: 1480, y: 230, type: 'robot', patrolDistance: 80 },
    { x: 1720, y: 280, type: 'bird',  patrolDistance: 85, variant: 1 },
  ],
  coins: [
...
const waterLevel16: LevelData = {
  ...
  enemies: [
    { type: 'jellyfish', x: 180,  y: 495, patrolDistance: 100, variant: 0 },
    { type: 'crab',      x: 780,  y: 495, patrolDistance: 180, variant: 0 },
    { type: 'jellyfish', x: 1600, y: 495, patrolDistance: 200, variant: 1 },
    { type: 'crab',      x: 2000, y: 495, patrolDistance: 150, variant: 0 },
    { type: 'jellyfish', x: 2420, y: 495, patrolDistance: 130, variant: 0 },
  ],
  coins: [
...
const waterLevel17: LevelData = {
  ...
  enemies: [
    { type: 'crab',      x: 160,  y: 425, patrolDistance: 120, variant: 0 },
    { type: 'jellyfish', x: 820,  y: 425, patrolDistance: 160, variant: 1 },
    { type: 'crab',      x: 1620, y: 425, patrolDistance: 200, variant: 0 },
    { type: 'jellyfish', x: 1900, y: 385, patrolDistance: 80,  variant: 0 },
    { type: 'crab',      x: 2540, y: 425, patrolDistance: 180, variant: 0 },
    { type: 'jellyfish', x: 2760, y: 425, patrolDistance: 100, variant: 1 },
  ],
  coins: [
...
const waterLevel18: LevelData = {
  ...
  enemies: [
    { type: 'crab',      x: 120,  y: 385, patrolDistance: 80,  variant: 1 },
    { type: 'jellyfish', x: 430,  y: 345, patrolDistance: 60,  variant: 0 },
    { type: 'crab',      x: 1140, y: 385, patrolDistance: 220, variant: 0 },
    { type: 'jellyfish', x: 1490, y: 345, patrolDistance: 60,  variant: 1 },
    { type: 'crab',      x: 1910, y: 385, patrolDistance: 80,  variant: 0 },
    { type: 'jellyfish', x: 2340, y: 385, patrolDistance: 200, variant: 0 },
    { type: 'crab',      x: 2620, y: 385, patrolDistance: 100, variant: 1 },
  ],
  coins: [
...
const waterLevel19: LevelData = {
  ...
  enemies: [
    { type: 'crab',      x: 100,  y: 385, patrolDistance: 80,  variant: 0 },
    { type: 'jellyfish', x: 410,  y: 345, patrolDistance: 60,  variant: 1 },
    { type: 'crab',      x: 830,  y: 345, patrolDistance: 60,  variant: 0 },
    { type: 'jellyfish', x: 1540, y: 385, patrolDistance: 180, variant: 0 },
    { type: 'crab',      x: 1890, y: 345, patrolDistance: 80,  variant: 1 },
    { type: 'jellyfish', x: 2160, y: 345, patrolDistance: 60,  variant: 0 },
    { type: 'crab',      x: 2740, y: 385, patrolDistance: 220, variant: 0 },
    { type: 'jellyfish', x: 3040, y: 385, patrolDistance: 100, variant: 1 },
  ],
  coins: [
...
const skyLevel24: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 100,  y: 385, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 570,  y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1360, y: 385, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 1870, y: 205, patrolDistance: 60,  variant: 1 },
    { type: 'bird', x: 2300, y: 385, patrolDistance: 120, variant: 0 },
  ],
  coins: [
    { x: 290, y: 330 }, { x: 430, y: 270 }, { x: 570, y: 210 },
...
const skyLevel25: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 90,   y: 385, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 550,  y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 980,  y: 385, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 1700, y: 385, patrolDistance: 120, variant: 1 },
    { type: 'bird', x: 2210, y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'bird', x: 2500, y: 385, patrolDistance: 100, variant: 1 },
  ],
  coins: [
    { x: 270, y: 330 }, { x: 410, y: 270 }, { x: 550, y: 210 },
...
const skyLevel26: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 90,   y: 365, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 550,  y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 980,  y: 365, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 1510, y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1940, y: 365, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 2600, y: 365, patrolDistance: 160, variant: 1 },
  ],
  coins: [
...
const skyLevel27: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 100,  y: 385, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 780,  y: 385, patrolDistance: 120, variant: 1 },
    { type: 'bird', x: 1530, y: 385, patrolDistance: 140, variant: 0 },
    { type: 'bird', x: 1930, y: 285, patrolDistance: 60,  variant: 1 },
    { type: 'bird', x: 2500, y: 385, patrolDistance: 160, variant: 0 },
    { type: 'bird', x: 2850, y: 185, patrolDistance: 80,  variant: 1 },
  ],
  coins: [
...
const skyLevel28: LevelData = {
  ...
  enemies: [
    { type: 'bird', x: 100,  y: 365, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 570,  y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1000, y: 365, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 1530, y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 1960, y: 365, patrolDistance: 120, variant: 0 },
    { type: 'bird', x: 2490, y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 2920, y: 365, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const skyLevel29: LevelData = {
  ...
  enemies: [
    ...
    { type: 'bird', x: 550,  y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'bird', x: 980,  y: 365, patrolDistance: 100, variant: 0 },
    { type: 'bird', x: 1860, y: 365, patrolDistance: 120, variant: 1 },
    { type: 'bird', x: 2390, y: 185, patrolDistance: 60,  variant: 0 },
    { type: 'bird', x: 2820, y: 365, patrolDistance: 120, variant: 1 },
    { type: 'bird', x: 3210, y: 245, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
    { x: 270, y: 310 }, { x: 410, y: 250 }, { x: 550, y: 190 },
...
const spaceLevel35: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 100,  y: 385, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 570,  y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 1400, y: 385, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 1930, y: 205, patrolDistance: 60,  variant: 1 },
    { type: 'robot', x: 2360, y: 385, patrolDistance: 120, variant: 0 },
  ],
  coins: [
    { x: 290, y: 330 }, { x: 430, y: 270 }, { x: 570, y: 210 },
...
const spaceLevel36: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 90,   y: 385, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 550,  y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 980,  y: 385, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 1510, y: 205, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 1940, y: 385, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 2470, y: 205, patrolDistance: 50,  variant: 1 },
  ],
  coins: [
    { x: 270, y: 330 }, { x: 410, y: 270 }, { x: 550, y: 210 },
    { x: 1230, y: 330 }, { x: 1370, y: 270 }, { x: 1510, y: 210 },
...
const spaceLevel37: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 100,  y: 365, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 570,  y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 1000, y: 365, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 1860, y: 365, patrolDistance: 140, variant: 1 },
    { type: 'robot', x: 2390, y: 185, patrolDistance: 60,  variant: 0 },
    { type: 'robot', x: 2680, y: 365, patrolDistance: 160, variant: 1 },
  ],
  coins: [
    { x: 290, y: 310 }, { x: 430, y: 250 }, { x: 570, y: 190 },
...
const spaceLevel38: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 100,  y: 365, patrolDistance: 120, variant: 0 },
    { type: 'robot', x: 780,  y: 365, patrolDistance: 120, variant: 1 },
    { type: 'robot', x: 1560, y: 365, patrolDistance: 140, variant: 0 },
    { type: 'robot', x: 1950, y: 265, patrolDistance: 60,  variant: 1 },
    { type: 'robot', x: 2520, y: 365, patrolDistance: 160, variant: 0 },
    { type: 'robot', x: 2910, y: 185, patrolDistance: 80,  variant: 1 },
  ],
  coins: [
...
const spaceLevel39: LevelData = {
  ...
  enemies: [
    { type: 'robot', x: 90,   y: 365, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 550,  y: 185, patrolDistance: 50,  variant: 1 },
    { type: 'robot', x: 980,  y: 365, patrolDistance: 100, variant: 0 },
    { type: 'robot', x: 1900, y: 365, patrolDistance: 120, variant: 1 },
    { type: 'robot', x: 2430, y: 185, patrolDistance: 60,  variant: 0 },
    { type: 'robot', x: 2860, y: 365, patrolDistance: 120, variant: 1 },
    { type: 'robot', x: 3250, y: 245, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
    { x: 270, y: 310 }, { x: 410, y: 250 }, { x: 550, y: 190 },
