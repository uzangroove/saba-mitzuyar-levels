...
export const LEVELS: LevelData[] = [
  // ---- LEVEL 1: Tutorial Earth ----
  {
    ...
    enemies: [
      ...
      { type: 'beetle', x: 800,  y: 460, patrolDistance: 120, variant: 0 },
      { type: 'crab',   x: 1200, y: 460, patrolDistance: 200, variant: 0 },
    ],
    coins: [
  ...
  // ---- LEVEL 2: Earth — Wider Gaps ----
  {
    ...
    enemies: [
      ...
      { type: 'beetle', x: 1250, y: 495, patrolDistance: 90,  variant: 0 },
      { type: 'bird',   x: 1500, y: 495, patrolDistance: 100, variant: 0 },
    ],
    coins: [
  ...
  // ---- LEVEL 3: Earth — Sunset ----
  {
    ...
    enemies: [
      { type: 'slime',   x: 300,  y: 410, patrolDistance: 200, variant: 0 },
      { type: 'beetle',  x: 700,  y: 410, patrolDistance: 140, variant: 0 },
      { type: 'spinner', x: 1100, y: 410, patrolDistance: 160, variant: 0 },
      { type: 'robot',   x: 1500, y: 410, patrolDistance: 120, variant: 0 },
    ],
    coins: [
...
const earthLevel4: LevelData = {
  ...
  enemies: [
    ...
    { type: 'robot',   x: 1900, y: 495, patrolDistance: 100, variant: 0 },
    { type: 'spinner', x: 2100, y: 495, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const earthLevel5: LevelData = {
  ...
  enemies: [
    ...
    { type: 'crab',    x: 1750, y: 495, patrolDistance: 120, variant: 0 },
    { type: 'beetle',  x: 1950, y: 495, patrolDistance: 100, variant: 0 },
    { type: 'robot',   x: 2200, y: 495, patrolDistance: 130, variant: 0 },
  ],
  coins: [
...
const earthLevel6: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',     x: 600,  y: 495, patrolDistance: 120, variant: 0 },
    { type: 'spinner',   x: 1100, y: 495, patrolDistance: 200, variant: 0 },
    { type: 'robot',     x: 2000, y: 495, patrolDistance: 150, variant: 0 },
    { type: 'jellyfish', x: 2200, y: 495, patrolDistance: 120, variant: 0 },
    { type: 'bird',      x: 2440, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const earthLevel7: LevelData = {
  ...
  enemies: [
    ...
    { type: 'crab',      x: 2150, y: 495, patrolDistance: 130, variant: 0 },
    { type: 'robot',     x: 2380, y: 495, patrolDistance: 120, variant: 0 },
    { type: 'jellyfish', x: 2650, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const earthLevel8: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',     x: 1150, y: 385, patrolDistance: 180, variant: 0 },
    { type: 'spinner',   x: 1490, y: 345, patrolDistance: 50,  variant: 0 },
    { type: 'robot',     x: 1950, y: 385, patrolDistance: 180, variant: 0 },
    { type: 'crab',      x: 2730, y: 385, patrolDistance: 150, variant: 0 },
    { type: 'jellyfish', x: 2900, y: 385, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const earthLevel9: LevelData = {
  ...
  enemies: [
    ...
    { type: 'robot',     x: 2040, y: 495, patrolDistance: 200, variant: 0 },
    { type: 'crab',      x: 2400, y: 415, patrolDistance: 50,  variant: 0 },
    { type: 'jellyfish', x: 2850, y: 495, patrolDistance: 150, variant: 0 },
    { type: 'bird',      x: 3050, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const waterLevel13: LevelData = {
  ...
  enemies: [
    ...
    { type: 'crab',      x: 900,  y: 495, patrolDistance: 180, variant: 0 },
    { type: 'slime',     x: 1680, y: 495, patrolDistance: 160, variant: 0 },
    { type: 'robot',     x: 1940, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const waterLevel14: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',     x: 1760, y: 415, patrolDistance: 50,  variant: 0 },
    { type: 'beetle',    x: 2220, y: 495, patrolDistance: 180, variant: 0 },
    { type: 'bird',      x: 2440, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const waterLevel15: LevelData = {
  ...
  enemies: [
    { type: 'jellyfish', x: 290,  y: 345, patrolDistance: 50,  variant: 0 },
    { type: 'crab',      x: 1140, y: 385, patrolDistance: 200, variant: 0 },
    { type: 'slime',     x: 1510, y: 345, patrolDistance: 50,  variant: 0 },
    { type: 'robot',     x: 2360, y: 385, patrolDistance: 200, variant: 0 },
    { type: 'beetle',    x: 2590, y: 385, patrolDistance: 120, variant: 0 },
    { type: 'bird',      x: 2780, y: 385, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
...
const waterBoss20: LevelData = {
  ...
  enemies: [
    ...
    { type: 'crab',      x: 800,  y: 495, patrolDistance: 100, variant: 0 },
    { type: 'slime',     x: 1200, y: 495, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const skyLevel21: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',   x: 820,  y: 385, patrolDistance: 140, variant: 0 },
    { type: 'spinner', x: 1500, y: 385, patrolDistance: 140, variant: 0 },
    { type: 'beetle',  x: 2200, y: 265, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const skyLevel22: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',     x: 550,  y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'spinner',   x: 980,  y: 385, patrolDistance: 100, variant: 0 },
    { type: 'crab',      x: 1510, y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'jellyfish', x: 1940, y: 385, patrolDistance: 100, variant: 0 },
  ],
  coins: [
...
const skyLevel23: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',   x: 570,  y: 245, patrolDistance: 50,  variant: 0 },
    { type: 'robot',   x: 1000, y: 405, patrolDistance: 120, variant: 0 },
    { type: 'beetle',  x: 1530, y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'crab',    x: 1960, y: 405, patrolDistance: 120, variant: 0 },
    { type: 'spinner', x: 2370, y: 245, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
...
const skyBoss30: LevelData = {
  ...
  enemies: [
    ...
    { type: 'spinner', x: 900,  y: 425, patrolDistance: 150, variant: 0 },
    { type: 'beetle',  x: 1400, y: 425, patrolDistance: 150, variant: 0 },
  ],
  coins: [
...
const spaceLevel33: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',   x: 570,  y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'spinner', x: 1000, y: 385, patrolDistance: 120, variant: 0 },
    { type: 'beetle',  x: 1530, y: 185, patrolDistance: 50,  variant: 0 },
    { type: 'crab',    x: 1960, y: 385, patrolDistance: 120, variant: 0 },
  ],
  coins: [
...
const spaceLevel34: LevelData = {
  ...
  enemies: [
    ...
    { type: 'slime',     x: 550,  y: 245, patrolDistance: 50,  variant: 0 },
    { type: 'beetle',    x: 980,  y: 405, patrolDistance: 100, variant: 0 },
    { type: 'spinner',   x: 1510, y: 205, patrolDistance: 50,  variant: 0 },
    { type: 'jellyfish', x: 1940, y: 405, patrolDistance: 100, variant: 0 },
    { type: 'bird',      x: 2350, y: 245, patrolDistance: 80,  variant: 0 },
  ],
  coins: [
...
const spaceBoss40: LevelData = {
  ...
  enemies: [
    ...
    { type: 'spinner', x: 900,  y: 425, patrolDistance: 150, variant: 0 },
    { type: 'slime',   x: 1400, y: 425, patrolDistance: 150, variant: 0 },
  ],
  coins: [
    { x: 300, y: 420 }, { x: 700, y: 420 }, { x: 1100, y: 420 },
